...
- Selecciona **Spring Boot Microservice**

### 2. Información del Componente
- **ID del Componente**: Identificador único (kebab-case, ej. `user-service`)
...
- Usar Spring Data JPA para operaciones de base de datos
- Implementar manejo adecuado de excepciones
- Seguir convenciones de API REST
- Usar Bean Validation para validación de entrada
